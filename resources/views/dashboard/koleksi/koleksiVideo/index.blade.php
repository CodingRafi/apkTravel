                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card" style="box-shadow: 0 0 0;">
                                            <div class="tampilanAwal" style="height: 19vh;overflow: hidden;">
                                                ...
                                                <div class="bag2" style="width: 45%;margin-left: 55%;position: absolute;height: 68%;">
                                                    <a href="/dashboard/koleksi/{{ $koleksies[$i]->slug }}/edit" class="btn btn-warning editKoleksi" style="padding: 5px;display: flex;justify-content: center;align-items: center;margin-left: 66%;position: absolute;z-index: 9;">
                                                    ...
                                                    <div class="bag1" style="height: 100%;width: 100%;display: flex;justify-content: center;align-items: center;color: #fff;font-weight: 600;font-size: 20px;">
                                                        @isset($videos[$i]['videoAda'])
                                                            <span>{{ count($videos[$i]['videoAda']) }}</span>
                                                        @endisset
                                                            
                                                        @isset($videos[$i]['videoGada'])
                                                            <span>0</span>
                                                        @endisset
                                                    </div>
                                                </div>
                                                @isset($videos[$i]['videoAda'])
                                                    <video src="{{ asset('storage/'.$videos[$i]['videoAda'][0]->filename) }}" class="card-img-top"></video>
                                                @endisset
                                                    
                                                @isset($videos[$i]['videoGada'])
                                                    <img src="{{ $videos[$i]['videoGada']}}" class="card-img-top">
                                                @endisset
