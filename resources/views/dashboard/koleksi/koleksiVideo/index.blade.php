                                        ...
                                        <div class="card" style="box-shadow: 0 0 0;">
                                            <div class="tampilanAwal" style="height: 19vh;overflow: hidden;">
                                                ...
                                                <div class="bag2" style="width: 45%;margin-left: 55%;position: absolute;height: 68%;">
                                                    <a href="/dashboard/koleksi/{{ $koleksies[$i]->slug }}/edit" class="btn btn-warning editKoleksi" style="padding: 5px;display: flex;justify-content: center;align-items: center;right: 0;position: absolute;z-index: 9;">
