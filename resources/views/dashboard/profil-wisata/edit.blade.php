                            ...
                            <div class="card-block">
                                <form action="/dashboard/profil-wisata/{{ $profilWisata->slug }}" method="post" enctype="multipart/form-data">
                                    ...
                                    {{-- <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="urutan" class="form-control">
                                                <option value="" {{ (old('urutan', $profilWisata->urutan)) ? '' : 'selected' }}>Urutan tampil</option>
                                                @for ($i = 1; $i <= 10; $i++)
                                                    <option value="{{ $i }}" {{ old('urutan', $profilWisata->urutan) == $i ? 'selected' : '' }}>{{ $i }}</option>
                                                @endfor
                                            </select>
                                            @error('urutan')   
                                            <div class="invalid-feedback d-block">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control @error('iframe') is-invalid @enderror" placeholder="Iframe Lokasi" name="iframe" id="iframe" value="{{ $profilWisata->iframe, old('iframe') }}">
                                            @error('iframe')   
                                            <div class="invalid-feedback d-block">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control @error('email') is-invalid @enderror" placeholder="email" name="email" id="email" value="{{ $profilWisata->email }}">
                                        </div>
                                        @error('email')   
                                        <div class="invalid-feedback d-block">
                                            {{ $message }}
