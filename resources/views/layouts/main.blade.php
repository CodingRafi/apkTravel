            ...
            <div class="peta-frame" >
                ...
                <map id="peta-depok" name="image-map" class="map" style="overflow: hidden;">
                  <a id="menutapos" alt="Tapos" class="linkmap" href="#">  <area  target="" data-key="tapos" onclick="divVisibility('Div1');" alt="tapos"
                        ...
                        shape="poly"></a>
                    <a id="menucilodong" href="#"><area target="" data-key="cilodong" onclick="divVisibility('Div2');" alt="cilodong"
                        ...
                        shape="poly"></a>
                    <a id="menucipayung" href="#"><area target="6" data-key="cipayung" onclick="divVisibility('Div3');" alt="cipayung"
                        ...
                        shape="poly"></a>
                    <a id="menusawangan" href="#"><area target="9" data-key="sawangan" onclick="divVisibility('Div4');" alt="sawangan"
                        ...
                        shape="poly"></a>
                    <a id="menubojongsari" href="#"><area target="2" data-key="bojongsari" onclick="divVisibility('Div5');" alt="bojongsari"
                        ...
                        shape="poly"></a>
                    <a href="#" id="menusukmajaya"><area target="10" data-key="sukmajaya" onclick="divVisibility('Div6');" alt="sukmajaya"
                        ...
                        shape="poly"></a>
                    <a href="#" id="menupancoranmas"><area target="8" data-key="pancoranmas" onclick="divVisibility('Div7');" alt="pancoranmas"
                        ...
                        shape="poly"></a>
                    <a href="#" id="menucimanggis"><area target="4" data-key="cimanggis" onclick="divVisibility('Div8');" alt="cimanggis"
                        ...
                        shape="poly"></a>
                    <a href="#" id="menubeji"><area target="1" data-key="beji" onclick="divVisibility('Div9');" alt="beji"
                        ...
                        shape="poly"></a>
                    <a href="#" id="menulimo"><area target="7" data-key="limo" onclick="divVisibility('Div10');" alt="limo"
                        ...
                        shape="poly"></a>
                    <a href="#" id="menucinere"><area target="5" data-key="cinere" onclick="divVisibility('Div11');" alt="cinere"
