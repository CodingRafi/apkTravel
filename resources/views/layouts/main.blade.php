            ...
            <div class="peta-frame">
                ...
                <map name="image-map">
                    <area target="" onclick="divVisibility('Div1');" alt="tapos"
                        ...
                        shape="poly">
                    <area target="" onclick="divVisibility('Div2');" alt="cilodong"
                        ...
                        shape="poly">
                    <area target="6" onclick="divVisibility('Div3');" alt="cipayung"
                        ...
                        shape="poly">
                    <area target="9" onclick="divVisibility('Div4');" alt="sawangan"
                        ...
                        shape="poly">
                    <area target="2" onclick="divVisibility('Div5');" alt="bojongsari"
                        ...
                        shape="poly">
                    <area target="10" onclick="divVisibility('Div6');" alt="sukmajaya"
                        ...
                        shape="poly">
                    <area target="8" onclick="divVisibility('Div7');" alt="pancoranmas"
                        ...
                        shape="poly">
                    <area target="4" onclick="divVisibility('Div8');" alt="cimanggis"
                        ...
                        shape="poly">
                    <area target="1" onclick="divVisibility('Div9');" alt="beji"
                        ...
                        shape="poly">
                    <area target="7" onclick="divVisibility('Div10');" alt="limo"
                        ...
                        shape="poly">
                    <area target="5" onclick="divVisibility('Div11');" alt="cinere"
