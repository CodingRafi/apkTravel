...
<body>
            ...
            <div class="peta-frame" >
                ...
                <map id="peta-depok" name="image-map" class="map" style="overflow: hidden;">
                    ...
                    <area target="" data-key="cilodong" onclick="divVisibility('Div2');" alt="cilodong"
                        ...
                        shape="poly">
                    <area target="6" data-key="cipayung" onclick="divVisibility('Div3');" alt="cipayung"
                        ...
                        shape="poly">
                    <area target="9" data-key="sawangan" onclick="divVisibility('Div4');" alt="sawangan"
                        ...
                        shape="poly">
                    <area target="2" data-key="bojongsari" onclick="divVisibility('Div5');" alt="bojongsari"
                        ...
                        shape="poly">
                    <area target="10" data-key="sukmajaya" onclick="divVisibility('Div6');" alt="sukmajaya"
                        ...
                        shape="poly">
                    <area target="8" data-key="pancoranmas" onclick="divVisibility('Div7');" alt="pancoranmas"
                        ...
                        shape="poly">
                    <area target="4" data-key="cimanggis" onclick="divVisibility('Div8');" alt="cimanggis"
                        ...
                        shape="poly">
                    <area target="1" data-key="beji" onclick="divVisibility('Div9');" alt="beji"
                        ...
                        shape="poly">
                    <area target="7" data-key="limo" onclick="divVisibility('Div10');" alt="limo"
                        ...
                        shape="poly">
                    <area target="5" data-key="cinere" onclick="divVisibility('Div11');" alt="cinere"
    ...
    <script>
        ...
        .mapster('test','tapos,cilodong,cipayung,sawangan,bojongsari,sukmajaya,pancoranmas,cimanggis,beji,limo,cinere') ;
    </script>
</body>
