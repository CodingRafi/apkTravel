...
<head>
    ...
    <title>Kategori in production</title>
        ...
        <div class="row g-2">
            <div class="col-md-9">
                <div class="card border-0 shadow h-100" >
                    <h1 style="width: 100%;background: none;box-shadow: none;margin-top: 10px;margin-left: 20px;">Coba
                    </h1>
                    <div class="card-body">
                        <div class="overflow-auto" style="height: 520px;">
                            <div class="row g-2" >
                                <div class="col-md-6">
                                    <div class="card">
                                        <img src="/images/home-screen/berita.jpg" class="card-img-top mh-100" alt="..." style="height: 133px;object-fit:cover;">
                                        <div class="card-body">
                                            <h5 class="card-title">Tes</h5>
                                            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit, provident!</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="overflow-auto" style="height: 480px">
                            ...
                            <ol class="list-group list-group bungcon12">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-start">
                                    <div class="ms-2 me-auto">
                                        <a class="fw-bold d-block text-decoration-none text-dark" href="#">tes</a>
                                        tes
                                    </div>
                                    <span class="badge text-dark @if($i==0) bg-warning @elseif ($i == 1) bg-secondary @else bg-light @endif rounded-pill">{{ $i+1 }}</span>
                                </li>
