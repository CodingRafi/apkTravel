                ...
                <div class="col-md-6">
                    ...
                    <map id="peta-depok" name="image-map" class="map" style="overflow: hidden;">
                        <a type="button" data-bs-toggle="modal" data-bs-target="#modal1"><area data-key="tapos"
                                ...
                                shape="poly"></a>
                        <a type="button" data-bs-toggle="modal" data-bs-target="#modal2"><area target=""
                                data-key="cilodong" alt="cilodong"
                                ...
                                shape="poly"></a>
                        <a type="button" data-bs-toggle="modal" data-bs-target="#modal3"><area target="6"
                                data-key="cipayung" alt="cipayung"
                                ...
                                shape="poly"></a>
                        <a type="button" data-bs-toggle="modal" data-bs-target="#modal4"><area target="9"
                                data-key="sawangan" alt="sawangan"
                                ...
                                shape="poly"></a>
                        <a type="button" data-bs-toggle="modal" data-bs-target="#modal5"><area target="2"
                                data-key="bojongsari" alt="bojongsari"
                                ...
                                shape="poly"></a>
                        <a type="button" data-bs-toggle="modal" data-bs-target="#modal6"><area target="10"
                                data-key="sukmajaya" alt="sukmajaya"
                                ...
                                shape="poly"></a>
                        <a type="button" data-bs-toggle="modal" data-bs-target="#modal7"><area target="8"
                                data-key="pancoranmas" alt="pancoranmas"
                                ...
                                shape="poly"></a>
                        <a type="button" data-bs-toggle="modal" data-bs-target="#modal8"><area target="4"
                                data-key="cimanggis" alt="cimanggis"
                                ...
                                shape="poly"></a>
                        <a type="button" data-bs-toggle="modal" data-bs-target="#modal9"><area target="1"
                                data-key="beji" alt="beji"
                                ...
                                shape="poly"></a>
                        <a type="button" data-bs-toggle="modal" data-bs-target="#modal10"><area target="7"
                                data-key="limo" alt="limo"
                                ...
                                shape="poly"></a>
                        <a type="button" data-bs-toggle="modal" data-bs-target="#modal11"><area target="5"
            ...
            <div class="col-md-3">
                <div class="card bg-light bg-grandient border-0 shadow h-100">
                    <div class="card-body">
                        ...
                        <hr>
                        @if(count($wisatas) <= 10) <ol class="list-group list-group bungcon12">
                            @for($i = 0; $i < count($wisatas); $i++) <li
                                ...
                                <span
                                    class="badge text-dark @if($i==0) bg-warning @elseif ($i == 1) bg-secondary bg-opacity-50 @else bg-light @endif rounded-pill">{{ $i+1 }}</span>
                                </li>
                                @endfor
                                </ol>
                                @else
                                <ol class="list-group list-group bungcon12">
                                    @for($i = 0; $i < $jumlah; $i++) <li
                                        class="list-group-item d-flex justify-content-between align-items-start">
                                        <div class="ms-2 me-auto">
                                            <a class="fw-bold d-block text-decoration-none text-dark"
                                                href="show/{{ $wisatas[$i]->slug }}">{{ $wisatas[$i]->nama }}</a>
                ...
                <div class="modal-body" style="max-height: 50vh">
                    <div class="d-flex align-items-start">
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab{{ $data->id }}" role="tablist"
                            aria-orientation="vertical" style="position: sticky; top: 0;">
                            <button class="nav-link active" id="v-pills-home-tab{{ $data->id }}" data-bs-toggle="pill"
                                data-bs-target="#v-pills-home{{ $data->id }}" type="button" role="tab"
                                aria-controls="v-pills-home{{ $data->id }}" aria-selected="true">Hotel</button>
                        ...
                        <div class="tab-content w-100" id="v-pills-tabContent{{ $data->id }}">
                            <div class="tab-pane fade show active" id="v-pills-home{{ $data->id }}" role="tabpanel"
                                aria-labelledby="v-pills-home-tab" tabindex="0">
                                <div class="row">
                                    @if (count($hotel[$data->slug]))
                                            ...
                                            <div class="card mb-3">
                                                <div class="row g-0">
                                                    <div class="col-md-4">
                                                        ...
                                                        <img src="{{ $fotoData[$i] }}" class="rounded-start h-100 w-100"
                                                            alt="..." style="object-fit: cover">
                                                        @else
                                                        <img src="{{ asset('storage/'.$hotel[$data->slug][$i]->filename) }}"
                                                            class="rounded-start h-100 w-100" alt="..."
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="card-body" style="height: 123px;">
                                                            ...
                                                            <p class="card-text"><small class="text-muted">{!!
                                                                    $hotel[$data->slug]{$i}->alamat !!}</small></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="container">
                                            <center>
                                                <p class="lead my-5">Hotel tidak tersedia</p>
                                            </center>
                                        </div>
                                    </div>
                                    @endif
                            ...
                            <div class="tab-pane fade" id="v-pills-profile{{ $data->id }}" role="tabpanel"
                                ...
                                <div class="row">
                                                ...
                                                <div class="row g-0">
                                                    <div class="col-md-4">
                                                        ...
                                                        <img src="{{ $fotoData[$i] }}" class="rounded-start h-100 w-100"
                                                            alt="..." style="object-fit: cover">
                                                        @else
                                                        <img src="{{ asset('storage/'.$destinasi[$data->slug][$i]->filename) }}"
                                                            class="rounded-start h-100 w-100" alt="..."
                                                            style="object-fit: cover">
                                                        @endif
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="card-body" style="height: 123px;">
                                                            ...
                                                            <p class="card-text"><small class="text-muted">{!!
                                                                    $destinasi[$data->slug][$i]->alamat !!}</small></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="container">
                                            <center>
                                                <p class="lead my-5">Destinasi tidak tersedia</p>
                                            </center>
                                        </div>
                                    </div>
                                    @endif
                            ...
                            <div class="tab-pane fade" id="v-pills-disabled{{ $data->id }}" role="tabpanel"
                                ...
                                <div class="row">
                                                ...
                                                <div class="row g-0">
                                                    <div class="col-md-4">
                                                        ...
                                                        <img src="{{ $fotoData[$i] }}" class="rounded-start h-100 w-100"
                                                            alt="..." style="object-fit: cover">
                                                        @else
                                                        <img src="{{ asset('storage/'.$makanan[$data->slug][$i]->filename) }}"
                                                            class="rounded-start h-100 w-100" alt="..."
                                                            style="object-fit: cover">
                                                        @endif
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="card-body" style="height: 123px;">
                                                            ...
                                                            <p class="card-text"><small class="text-muted">{!!
                                                                    $makanan[$data->slug]{$i}->alamat !!}</small></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="container">
                                            <center>
                                                <p class="lead my-5">Makanan tidak tersedia</p>
                                            </center>
                                        </div>
                                    </div>
                                    @endif
                            ...
                            <div class="tab-pane fade" id="v-pills-messages{{ $data->id }}" role="tabpanel"
                                ...
                                <div class="row">
                                                ...
                                                <div class="row g-0">
                                                    <div class="col-md-4">
                                                        ...
                                                        <img src="{{ $fotoData[$i] }}" class="rounded-start h-100 w-100"
                                                            alt="..." style="object-fit: cover">
                                                        @else
                                                        <img src="{{ asset('storage/'.$travel[$data->slug][$i]->filename) }}"
                                                            class="rounded-start h-100 w-100" alt="..."
                                                            style="object-fit: cover">
                                                        @endif
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="card-body" style="height: 123px;">
                                                            ...
                                                            <p class="card-text"><small class="text-muted">{!!
                                                                    $travel[$data->slug]{$i}->alamat !!}</small></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="container">
                                            <center>
                                                <p class="lead my-5">Travel tidak tersedia</p>
                                            </center>
                                        </div>
                                    </div>
                                    @endif
                            ...
                            <div class="tab-pane fade" id="v-pills-settings{{ $data->id }}" role="tabpanel"
                                ...
                                @if (count($oleh[$data->slug]))
                                                ...
                                                <div class="row g-0">
                                                    <div class="col-md-4">
                                                        ...
                                                        <img src="{{ $fotoData[$i] }}" class="rounded-start h-100 w-100"
                                                            alt="..." style="object-fit: cover">
                                                        @else
                                                        <img src="{{ asset('storage/'.$oleh[$data->slug][$i]->filename) }}"
                                                            class="rounded-start h-100 w-100" alt="..."
                                                            style="object-fit: cover">
                                                        @endif
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="card-body" style="height: 123px;">
                                                            ...
                                                            <p class="card-text"><small class="text-muted">{!!
                                                                    $oleh[$data->slug]{$i}->alamat !!}</small></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="container">
                                            <center>
                                                <p class="lead my-5">Oleh oleh tidak tersedia</p>
                                            </center>
                                        </div>
                                    </div>
                                    @endif
